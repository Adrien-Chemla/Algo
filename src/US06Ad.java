...
public class US06Ad {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("\nPour retourner au menu entrez un caractère : ");
    ...
    public static void creator(){
      ...
      int ing = 1;
        ...
        while ( ing == 1) {
        System.out.println("ingredient : ( ex: pates)");
        String ingredient = scanner2.next();

        System.out.println("ingredient quantity (ex : 3)");
        ...
        for (int a = 1; a < 2; a++ ) {
          ...
          System.out.println("\nEntrées effectuées pour la recette : " + str);
          }
